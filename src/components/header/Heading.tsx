...
useEffect(() => {
  ...
  return () => clearInterval(interval); 
    ...
    return <section className="grid place-content-start h-full">
        ...
        <div className="absolute top-1/2 left-4 p-12 mt-6 md:p-24 transform -translate-y-1/2">
        <h1 className="z-20 mb-6 text-left uppercase font-bold text-5xl text-gray-300 lg:text-7xl">
        ...
        <div className="mt-6 text-3xl text-gray-300">
