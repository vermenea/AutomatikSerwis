...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className='fixed top-0 z-10 w-full bg-black/50 backdrop-blur-lg text-white p-3 font-semibold flex justify-between items-center min-h-[70px] gap-10'>
      ...
      <ul className={`flex justify-between items-center gap-15 text-white ${isActive ? 'flex-col absolute top-[70px] left-0 w-full p-3 transition-all ease-in-out duration-700 bg-black bg-opacity-50 backdrop-blur-lg' : 'hidden sm:flex'}`}>
